...
\begin{small}
% Set calendar box height
\setlength{\calboxdepth}{\baselineskip}
% Set all calendar text to be in tiny font
\renewcommand{\calprintdate}{%
\tiny{\ifnewmonth\framebox{\monthname\ \ordinaldate}%
\else \ordinaldate \fi}
}
\renewcommand{\calprintclass}{\textbf{\tiny\theclassnum}}
\makeatletter
\renewcommand\caltext[2]{\ca@addmacro{#1text}{\tiny{#2\par}}}
\makeatother

% Remember: remove leading zeros from month and day specifications.
% Ref: http://newsgroups.derkeiler.com/Archive/Comp/comp.text.tex/2005-08/msg01189.html
\begin{calendar}{1/9/2012}{17}
...
\skipday\skipday
\options{1/9/2012}{\noclassday} % Calendar starts on Monday, Jan. 9, but class starts on Wednesday, Jan. 11
% Holidays
\options{1/16/2012}{\noclassday} \caltext{1/16/2012}{No Class, MLK Day}
% Course schedule
\caltexton{1}{Intro, R.2}
\caltextnext{R2, R.4}
\end{calendar}
\end{small}